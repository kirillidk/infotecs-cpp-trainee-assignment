...
namespace logger {
    class Logger {
    public:
        [[nodiscard]] static std::shared_ptr<Logger> create_logger(const std::string &filename,
                                                                   LogLevel default_level = LogLevel::INFO);
        [[nodiscard]] static std::shared_ptr<Logger> create_logger(const std::string &host, int port,
                                                                   LogLevel default_level = LogLevel::INFO);
